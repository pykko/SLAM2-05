...
public class AppXDQ {
	...
	public static void main(String[] args) {
		...
		//	5.5- Afficher l'état (capturé ou dans le jeu) l'animal représenté sur le pion qui se trouve sur la case (5,4)
		// VOTRE CODE ICI
		...
		//	9.1- Créer le pion noir qui représente le chat (force de niveau 2)
		//			Ce pion est dans le jeu car non capturé
		//			Pion référencé par la variable chatNoir
		// VOTRE CODE ICI
		
		//	9.2- Créer la case qui se trouve en ligne 6 et en colonne 5
		//			Cette case est occupée par le chat noir
		//			Case référencée par la variable case65
		// VOTRE CODE ICI
		
		System.out.println( "9.3" ) ;
		//	9.3- Afficher le chat noir ainsi que la case (6,5)
		// VOTRE CODE ICI
		
		//	9.4- Déplacer le loup blanc sur la case (6,5)
		//			Si le déplacement a été réalisé avec succès, afficher le message "Loup blanc déplacé."
		//			Si le déplacement n'a pu être réalisé, afficher le message "Loup blanc non déplacé."
		// VOTRE CODE ICI		

		System.out.println( "9.5" ) ;
		//	9.5- Afficher le chat noir et le loup blanc ainsi que les cases (5,5) et (6,5)
		// VOTRE CODE ICI
		...
		// Question 10 - Déplacer le loup blanc
		//		ATTENTION : Un pion ne peut se déplacer que s'il est en jeu ET...
		//						Si la case de destination est vide
		//					OU  Si la case de destination est occupée par un pion adverse dont la force
		//						   est inférieure ou égale au pion qui se déplace
		
		//	10.1- Créer le pion noir qui représente la panthère (force de niveau 5)
		//			Ce pion est dans le jeu car non capturé
		//			Pion référencé par la variable panthereNoire
		// VOTRE CODE ICI
		
		//	10.2- Créer la case qui se trouve en ligne 7 et en colonne 5
		//			Cette case est occupée par la panthère noire
		//			Case référencée par la variable case75
		// VOTRE CODE ICI
		
		System.out.println( "10.3" ) ;
		//	10.3- Afficher la panthère noire ainsi que la case (7,5)
		// VOTRE CODE ICI
		
		//	10.4- Déplacer le loup blanc sur la case (7,5)
		//			Si le déplacement a été réalisé avec succès, afficher le message "Loup blanc déplacé."
		//			Si le déplacement n'a pu être réalisé, afficher le message "Loup blanc non déplacé."
		// VOTRE CODE ICI		

		System.out.println( "10.5" ) ;
		//	10.5- Afficher la panthère noire et le loup blanc ainsi que les cases (6,5) et (7,5)
		// VOTRE CODE ICI
		...
		//	11.1- Créer le pion blanc qui représente l'éléphant (force de niveau 8)
		//			Ce pion est dans le jeu car non capturé
		//			Pion référencé par la variable elephantBlanc
		// VOTRE CODE ICI
		
		//	11.2- Créer la case qui se trouve en ligne 1 et en colonne 1
		//			Cette case est occupée par l'éléphant blanc
		//			Case référencée par la variable case11
		// VOTRE CODE ICI

		//	11.3- Créer le pion noir qui représente le rat (force de niveau 1)
		//			Ce pion est dans le jeu car non capturé
		//			Pion référencé par la variable ratNoir
		// VOTRE CODE ICI
		
		//	11.4- Créer la case qui se trouve en ligne 1 et en colonne 2
		//			Cette case est occupée par le rat noir
		//			Case référencée par la variable case12
		// VOTRE CODE ICI
				
		System.out.println( "11.5" ) ;
		//	11.5- Afficher l'éléphant blanc et le rat noir ainsi que les cases (1,1) et (1,2)
		// VOTRE CODE ICI
		...
		//	11.7- Afficher l'éléphant blanc et le rat noir ainsi que les cases (1,1) et (1,2)
		// VOTRE CODE ICI
		...
		//	12.1- Créer le pion noir qui représente l'éléphant (force de niveau 8)
		//			Ce pion est dans le jeu car non capturé
		//			Pion référencé par la variable elephantNoir
		// VOTRE CODE ICI
		
		//	12.2- Créer la case qui se trouve en ligne 9 et en colonne 1
		//			Cette case est occupée par l'éléphant noir
		//			Case référencée par la variable case91
		// VOTRE CODE ICI

		//	12.3- Créer le pion blanc qui représente le rat (force de niveau 1)
		//			Ce pion est dans le jeu car non capturé
		//			Pion référencé par la variable ratBlanc
		// VOTRE CODE ICI
		
		//	12.4- Créer la case qui se trouve en ligne 9 et en colonne 2
		//			Cette case est occupée par le rat blanc
		//			Case référencée par la variable case92
		// VOTRE CODE ICI
				
		System.out.println( "12.5" ) ;
		//	12.5- Afficher l'éléphant noir et le rat blanc ainsi que les cases (9,1) et (9,2)
		// VOTRE CODE ICI
		
		//	12.6- Déplacer l'éléphant noir sur la case (9,2)
		...
		//	12.7- Afficher l'éléphant noir et le rat blanc ainsi que les cases (9,1) et (9,2)
		// VOTRE CODE ICI		
		
		
		
		System.out.println( "\n[Question 13] Créer les pions" ) ;
		// Question 13 - Créer les pions"
		...
		//	13.1- Valoriser les variables pionsBlancs et pionsNoirs
		//			Créer tous les pions et les mémoriser dans leur tableau respectif
		// VOTRE CODE ICI

		System.out.println( "13.2" ) ;
		//	13.2- Afficher les pions blancs puis les pions noirs
		// VOTRE CODE ICI
		
		System.out.println( "13.3" ) ;
		//	13.2- Afficher la couleur de chacun des pions
		// VOTRE CODE ICI
		
		
		
		System.out.println( "\n[Question 14] Créer les cases" ) ;
		// Question 14 - Créer les cases
		//		Tourtes les cases sont libres
		Case [][] cases = new Case[ NB_LIGNES ][NB_COLONNES ] ;
		

		//	14.1- Valoriser la variable cases
		...
		System.out.println( "\n[Question 15] Positionner les pions" ) ;
		// Question 15 - Positionner les pions
		// 			Les pions blancs sont positionnés dans la première colonne
		//			Les pions noirs sont positionnés dans la dernière colonne
		
		//	15.1- Positionner les pions
		// VOTRE CODE ICI
		
		System.out.println( "15.2" ) ;
		//	15.2- Afficher les cases
		// VOTRE CODE ICI
		
		System.out.println( "15.3" ) ;
		//	15.3- Pour chaque case occupée afficher sa ligne, sa colonne ainsi que le nom de l'animal qui l'occupe
		// VOTRE CODE ICI

		System.out.println( "15.4" ) ;
		//	15.4- Pour chaque case occupée afficher sa ligne, sa colonne ainsi que le nom et la couleur 
